        ...
        <div className="flex-1 grid grid-rows-[auto,1fr,auto] min-h-0">
            ...
            <div className="min-h-0 overflow-y-hidden">
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full h-full flex flex-col">
                    ...
                    <TabsContent value="mediums" className="flex-1 min-h-0">
                        <ScrollArea className="h-full w-full">
                            <div className="p-6">
                                <Card className="border-0 shadow-none">
                                    <CardHeader className="p-0 pb-4">
                                    ...
                                    <CardContent className="p-0 space-y-6">
                                        <AlertDialog>
                                            ...
                                            <AlertDialogContent>
                                                ...
                                                <AlertDialogFooter>
                                                    <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                                    <AlertDialogAction onClick={() => archiveAndResetGira().then(message => toast({ title: "Operação Concluída", description: message }))}>
